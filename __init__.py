...
from . import image_batch_select
...
from . import save_image_dynamic
...
NODE_CLASS_MAPPINGS.update(image_batch_select.NODE_CLASS_MAPPINGS)
NODE_DISPLAY_NAME_MAPPINGS.update(image_batch_select.NODE_DISPLAY_NAME_MAPPINGS)
...
NODE_CLASS_MAPPINGS.update(save_image_dynamic.NODE_CLASS_MAPPINGS)
NODE_DISPLAY_NAME_MAPPINGS.update(save_image_dynamic.NODE_DISPLAY_NAME_MAPPINGS)
...
__all__ += getattr(image_batch_select, "__all__", [])
...
__all__ += getattr(save_image_dynamic, "__all__", [])
